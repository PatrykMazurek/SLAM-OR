...
if draw_rect1 == True:
    fig_name = "results/reference_id=" + recording_id + ".png"
if draw_rect2 == True:
    fig_name = "results/results_id=" + recording_id + ",eps=" + str(dbscan_eps) + ",min=" + str(dbscan_min) + ",box_size=" + str(box_size) + ".png"
if draw_points2 == True:
    fig_name = "results/results_id=" + recording_id + ",eps=" + str(dbscan_eps) + ",min=" + str(dbscan_min) + ",points_dilation.png"
"""
draw_rect1 = False
draw_rect2 = True
"""
