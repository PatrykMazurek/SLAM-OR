...
if draw_rect1 == True:
    fig_name = "resultsMobileNet/reference_id=" + recording_id + ".png"
if draw_rect2 == True:
    fig_name = "resultsMobileNet/results_id=" + recording_id + ",eps=" + str(dbscan_eps) + ",min=" + str(dbscan_min) + ",box_size=" + str(box_size) + ".png"
if draw_points2 == True:
    fig_name = "resultsMobileNet/results_id=" + recording_id + ",eps=" + str(dbscan_eps) + ",min=" + str(dbscan_min) + ",points_dilation.png"
"""
draw_rect1 = False
draw_rect2 = True
"""
...
def show_2D_map(file_number):
    ...
    with open('dataMobileNet/date-form-MobileNet-' + str(file_number) + '.csv', 'r') as c_f:
    ...
    item_counter = 0
    with open('dataMobileNet/point-from-MobileNet-' + str(file_number) + '.csv', 'r') as fr:
