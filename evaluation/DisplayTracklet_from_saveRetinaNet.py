...
recording_id = "23"
#yaw_correction = 0.14
yaw_correction = 0.155
how_much_skip = 1
offset_help = 10
#scale_x = scale_y = 0.82
scale_x = scale_y = 0.77
dbscan_eps = 1.5
dbscan_min = 7
min_samples=1
...
recording_id = "61"
yaw_correction = -0.024
how_much_skip = 1
offset_help = 1
scale_x = scale_y = 0.89
dbscan_eps = 1.5
dbscan_min = 7
min_samples=1
...
recording_id = "84"
#yaw_correction = 0.021
yaw_correction = 0.005
how_much_skip = 1
#offset_help = 75
offset_help = 65
scale_x = scale_y = 0.4825
dbscan_eps = 1.5
dbscan_min = 7
min_samples= 1
...
if draw_rect1 == True:
    fig_name = "resultsRetinaNet/reference_id=" + recording_id + ".png"
if draw_rect2 == True:
    fig_name = "resultsRetinaNet/results_id=" + recording_id + ",eps=" + str(dbscan_eps) + ",min=" + str(dbscan_min) + ",box_size=" + str(box_size) + ".png"
if draw_points2 == True:
    fig_name = "resultsRetinaNet/results_id=" + recording_id + ",eps=" + str(dbscan_eps) + ",min=" + str(dbscan_min) + ",points_dilation.png"
"""
draw_rect1 = False
draw_rect2 = True
"""
...
def show_2D_map(file_number):
    ...
    with open('dataRetinaNet/date-form-RetinaNet-' + str(file_number) + '.csv', 'r') as c_f:
    ...
    item_counter = 0
    with open('dataRetinaNet/point-from-RetinaNet-' + str(file_number) + '.csv', 'r') as fr:
...
clustering = DBSCAN(eps=dbscan_eps, min_samples=dbscan_min).fit(vv)
